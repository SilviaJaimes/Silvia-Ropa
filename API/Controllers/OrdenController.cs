...
public class OrdenController : BaseApiController
{
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Pager<OrdenDto>>> GetPaginacion([FromQuery] Params OrdenParams)
    {
        var entidad = await unitofwork.Ordenes.GetAllAsync(OrdenParams.PageIndex, OrdenParams.PageSize, OrdenParams.Search);
